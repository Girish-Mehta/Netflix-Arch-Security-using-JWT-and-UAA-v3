...
public class RegistrationController {
	...
	public String getUserInformationn(@PathVariable String id, @PathVariable String password) {
		String message = "";
		String getPassword = "";
		UserInformation info = null;
		Optional<UserInformation> retrieverIformation = userService.getUserInformation(id);
